...
def _load_sigmahq_json() -> Dict[str, str]:
    ...
    sigmahq_provider_version = json_data["version"]
    sigmahq_provider_name = json_data["category_provider_name"]

    result = {
        "sigmahq_provider_version": sigmahq_provider_version or "unknown",
